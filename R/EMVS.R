...
EMVS <- function(Y,
  ...
  if(independent == TRUE) {
      res <- conjugate_EMVS(YY, XX, v0, v1, type, beta_init, sigma_init, epsilon, temperature, theta, a, b, direction)
  } else {
      res <- conjugate_EMVS(YY, XX, v0, v1, type, beta_init, sigma_init, epsilon, temperature, theta, a, b, v1_g, direction)
  }
